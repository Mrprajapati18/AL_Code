page 50410 "Role Center for Bussiness"
{
    Caption = 'Business Manager Role Center for ';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            // part("Sales analysis"; "Sales analysis_")
            // {
            //     ApplicationArea = all;
            // }
            ...
            // }
            // part("Collection Analysis"; "Collection Analysis")
            // {
            //     ApplicationArea = all;
            // }
            // part("Inventory Analysis By Segment"; "Inventory Analysis By Segment")
            // {
            ...
            // part(bankAccDetails; "Bank Acc Details")
            // {
            //     Caption = 'Bank Balance';
            //     ApplicationArea = all;
            // }
            // part("FDR&Cash ListPlus"; "FDR&Cash ListPlus")
            // {
            //     ApplicationArea = all;
            // }

            // part(Control9; "PB Trial Balance") //MKMK
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            group("Delegation ")
            {
                ...
                action("Delegate Workflow ")
                {
                    ...
                    Image = Delegate;
                    //RunObject = page "Delegate Workflow";
                }
                action("Reverse Delegation ")
                {
                    ApplicationArea = All;
                    Image = ReverseLines;
                   // RunObject = page "Reverse Workflow";
                }
            }

            group("Assign SalesPerosn")
            {
                action("Customer List")
                {
                    Image = SalesPerson;
                    ApplicationArea = All;
                    //RunObject = page "Update Salesperson";
                }
            }
            ...
            action("Trial Balance Itek")
            {
                ApplicationArea = All;
                Ellipsis = true;
               // RunObject = report "Trial Balance Itek";
                Image = ReOpen;
            }
            action("Audit Report")
            {
                ApplicationArea = All;
                Ellipsis = true;
                //RunObject = report "Day Book 2.";
                Image = ReOpen;
            }
            action("Invoice PNL Report")
            {
                ApplicationArea = All;
                Ellipsis = true;
                //RunObject = report "Invoice PNL Report";
                Image = Report;
            }
        }
        area(sections)
        {
            ...
            group(Action42)
            {
                ...
                Image = AdministrationSalesPurchases;
                ToolTip = 'Show actual selling price of items according to their Age';
                action("Below 45 Days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Inv Age Below 45 Days';
                    //RunObject = Page "Selling Price Information <45";
                    ToolTip = 'Show actual selling price of items whose age is below 45 days';
                }
                action("45-90 Days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Inv Age 45-90 Days';
                   // RunObject = Page "Selling Price Info 45-90";
                    ToolTip = 'Show actual selling price of items whose age in between 45 to 90  days';
                }
                action("91-180 Days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Inv Age 91-180 Days';
                   // RunObject = Page "Selling Price Info 91-180";
                    ToolTip = 'Show actual selling price of items whose age in between 91 to 180  days';
                }
                action("181-360 Days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Inv Age 181-360 Days';
                   // RunObject = Page "Selling Price Info 181-360";
                    ToolTip = 'Show actual selling price of items whose age in between 181 to 360  days';
                }
                action("Above 360 Days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Inv Age Above 360 Days';
                    //RunObject = Page "Selling Price Information >360";
                    ToolTip = 'Show actual selling price of items whose age is above 360 days';
                }
            }
