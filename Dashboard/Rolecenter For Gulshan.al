page 50016 "Rolecenter For Gulshan"
{
    Caption = 'Rolecenter For Gulshan';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            // part("Sales analysis SNS"; "Sales analysis SNS")
            // {
            //     ApplicationArea = Basic, Suite;
            // }

            // part("Sales analysis SNS CSG"; "Sales analysis SNS CSG")
            // {
            //     ApplicationArea = Basic, Suite;
            // }
            part("Sales analysis SNS ISG"; "Sales analysis SNS ISG")
            {
                ApplicationArea = Basic, Suite;
            }
            // part("Sales analysis SNS GL"; "Sales analysis SNS GL")
            // {
            //     ApplicationArea = Basic, Suite;
            // }

            part("Inventory Analysis By Segment"; "Inventory Analysis By Seg SNS")
            {
                ApplicationArea = Basic, Suite;
            }
