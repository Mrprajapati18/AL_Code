page 50041 "Item Inv Details B2B"
{
    Caption = 'Item Inv Details B2B';
    PageType = List;
    SourceTable = Item;
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Inv Below 45 Days"; Rec."Inv Below 45 Days B2B")
                {
                ...
                field("Inv 45-90 Days"; Rec."Inv 45-90 Days B2B")
                {
                ...
                field("Inv Below 91-180 Days"; Rec."Inv Below 91-180 Days B2B")
                {
                ...
                field("Inv Below 181-360 Days"; Rec."Inv Below 181-360 Days B2B")
                {
                ...
                field("Inv Above 360 Days"; Rec."Inv Above 360 Days B2B")
                {
