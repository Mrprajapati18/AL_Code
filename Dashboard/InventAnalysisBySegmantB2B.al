page 50083 "Inventory Analysis By Seg B2B"
{
            ...
            cuegroup(control1)
            {
                ...
                field(InvBlow45; InvBlow45CSG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 45 Days CSG B2B", '<>%1', 0);
                ...
                field(Inv45to90; Inv45to90CSG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv 45-90 Days CSG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv91to180; Inv91to180CSG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 91-180 Days CSG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv181to360; Inv181to360CSG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 181-360 Days CSG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(InvAbove360; InvAbove360CSG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Above 360 Days CSG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
            ...
            cuegroup(control2)
            {
                ...
                field(InvBlow45ISG; InvBlow45ISG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 45 Days ISG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv45to90ISG; Inv45to90ISG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv 45-90 Days ISG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv91to180ISG; Inv91to180ISG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 91-180 Days ISG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv181to360ISG; Inv181to360ISG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 181-360 Days ISG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(InvAbove360ISG; InvAbove360ISG)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Above 360 Days ISG B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
            ...
            cuegroup(control3)
            {
                ...
                field(InvBlow45Blank; InvBlow45Blank)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 45 Days Blank B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv45to90Blank; Inv45to90Blank)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv 45-90 Days Blank B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv91to180Blank; Inv91to180Blank)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 91-180 Days Blk B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(Inv181to360Blank; Inv181to360Blank)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Below 181-360 Days Blk B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
                ...
                field(InvAbove360Blank; InvAbove360Blank)
                {
                    ...
                    begin
                        Clear(ITEMDetails);
                        ItemCatRec.Reset();
                        ItemCatRec.SetFilter("Inv Above 360 Days Blank B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(ItemCatRec);
    ...
    var
        ...
        ITEMDetails: Page "Brand Inv Details B2B";
