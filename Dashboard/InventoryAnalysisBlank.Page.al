// page 50079 "Inventory Analysis Blank"
// {
//     Caption = 'Inventory Analysis Blank';
//     PageType = CardPart;
...
//                         ProdSeg: Record "Product Segment";
//                         ILE1: Record "Item Ledger Entry";
//                     begin
//                         ILE1.Reset();
//                         ProdSeg.Reset();
//                         ProdSeg.SetFilter(Segmant, '<>%1 & <>%2', ProdSeg.Segmant::CSG, ProdSeg.Segmant::ISG);
//                         if ProdSeg.FindSet() then
//                             repeat
//                                 ILE.Reset();
//                                 ILE.SetRange("Item Category Code", ProdSeg."Item Category Code");
//                                 if ILE.FindSet() then begin
//                                     repeat
//                                         if ILE1.Get(ILE."Entry No.") then
//                                             ILE1.Mark(true);
//                                     until ILE.Next() = 0;
//                                 end;
//                             until ProdSeg.Next() = 0;
//                         ILE1.MarkedOnly(true);
//                         if ILE1.FindSet() then;
//                         Page.Run(Page::"Selling Price Information <45", ILE1);
//                     end;
//                 }
...
//     trigger OnOpenPage()
//     var
//         ProdSegment: Record "Product Segment";
//     begin
//         Clear(InvBlow45);
//         Clear(Inv45to90);
//         Clear(Inv91to180);
...
//         Clear(InvAbove360);
//         ProdSegment.Reset();
//         ProdSegment.SetFilter(Segmant, '<>%1 & <>%2', ProdSegment.Segmant::CSG, ProdSegment.Segmant::ISG);
//         if ProdSegment.FindFirst() then
//             repeat
//                 // Clear(InvBlow45);
//                 ILE.Reset();
//                 ILE.SetRange(Open, true);
//                 ILE.SetRange("Item Category Code", ProdSegment."Item Category Code");
