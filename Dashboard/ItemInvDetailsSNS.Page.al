page 50079 "Item Inv Details SNS"
{
    Caption = 'Item Inv Details SNS';
    PageType = List;
    SourceTable = Item;
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Inv Below 45 Days"; Rec."Inv Below 45 Days SNS")
                {
                ...
                field("Inv 45-90 Days"; Rec."Inv 45-90 Days SNS")
                {
                ...
                field("Inv Below 91-180 Days"; Rec."Inv Below 91-180 Days SNS")
                {
                ...
                field("Inv Below 181-360 Days"; Rec."Inv Below 181-360 Days SNS")
                {
                ...
                field("Inv Above 360 Days"; Rec."Inv Above 360 Days SNS")
                {
