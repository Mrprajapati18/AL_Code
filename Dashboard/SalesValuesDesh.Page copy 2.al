// page 50093 "Sales Values Dash B2B"
// {
//     Caption = 'Sales Values Dash B2B';
//     PageType = CardPart;
...
//                         CLERec.SetRange("Business Type", CLE."Business Type"::B2B);
...
//                         CLE.SetRange("Business Type", CLE."Business Type"::B2B);
...
//         StockValue := 0;
//         ValueEntry.Reset();
//         ValueEntry.SetRange("Purchase Type", ValueEntry."Purchase Type"::B2B);
