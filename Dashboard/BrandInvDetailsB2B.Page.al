page 50093 "Brand Inv Details B2B"
{
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Inv Below 45 Days CSG"; Rec."Inv Below 45 Days CSG B2B")
                {
                    ...
                    begin
                        ...
                        Item.SetFilter("Inv Below 45 Days B2B", '<>%1', 0);
                ...
                field("Inv 45-90 Days CSG"; Rec."Inv 45-90 Days CSG B2B")
                {
                    Caption = 'Brand Inventory';
                    ...
                    begin
                        ...
                        Item.SetRange("Item Brand", Rec.Code);
                        Item.SetRange("Prod Segment", Item."Prod Segment"::CSG);
                        Item.SetFilter("Inv 45-90 Days B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(Item);
                ...
                field("Inv Below 91-180 Days CSG"; Rec."Inv Below 91-180 Days CSG B2B")
                {
                    Caption = 'Brand Inventory';
                    ...
                    begin
                        ...
                        Item.SetRange("Item Brand", Rec.Code);
                        Item.SetRange("Prod Segment", Item."Prod Segment"::CSG);
                        Item.SetFilter("Inv Below 91-180 Days B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(Item);
                ...
                field("Inv Below 181-360 Days CSG"; Rec."Inv Below 181-360 Days CSG B2B")
                {
                    Caption = 'Brand Inventory';
                    ...
                    begin
                        ...
                        Item.SetRange("Item Brand", Rec.Code);
                        Item.SetRange("Prod Segment", Item."Prod Segment"::CSG);
                        Item.SetFilter("Inv Below 181-360 Days B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(Item);
                ...
                field("Inv Above 360 Days CSG"; Rec."Inv Above 360 Days CSG B2B")
                {
                    Caption = 'Brand Inventory';
                    ...
                    begin
                        ...
                        Item.SetRange("Item Brand", Rec.Code);
                        Item.SetRange("Prod Segment", Item."Prod Segment"::CSG);
                        Item.SetFilter("Inv Above 360 Days B2B", '<>%1', 0);
                        ITEMDetails.SetTableView(Item);
                ...
                field("Inv Below 45 Days ISG"; Rec."Inv Below 45 Days ISG B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv 45-90 Days ISG"; Rec."Inv 45-90 Days ISG B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Below 91-180 Days ISG"; Rec."Inv Below 91-180 Days ISG B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Below 181-360 Days ISG"; Rec."Inv Below 181-360 Days ISG B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Above 360 Days ISG"; Rec."Inv Above 360 Days ISG B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Below 45 Days Blank"; Rec."Inv Below 45 Days Blank B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv 45-90 Days Blank"; Rec."Inv 45-90 Days Blank B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Below 91-180 Days Blank"; Rec."Inv Below 91-180 Days Blk B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Below 181-360 Days Blank"; Rec."Inv Below 181-360 Days Blk B2B")
                {
                    Caption = 'Brand Inventory';
                ...
                field("Inv Above 360 Days Blank"; Rec."Inv Above 360 Days Blank B2B")
                {
                    Caption = 'Brand Inventory';
    ...
    var
        ...
        ITEMDetails: Page "Item Inv Details B2B";
        ItemRec: Record Item;
}