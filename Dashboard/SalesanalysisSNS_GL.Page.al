// page 50068 "Sales analysis SNS GL"
// {
//     Caption = 'Sales Analysis SNS GL';
//     PageType = CardPart;
...
//                     end;
//                 }
//                 field(TotalSaleAmtBlank; TotalSaleAmtYTDBlank)
//                 {
//                     ApplicationArea = Basic, Suite;
//                     Caption = 'YTD Sales Amt Blank';
...
//                 SalesPersonRec.Reset();
//                 SalesPersonRec.SetRange(Code, CLE."Salesperson Code");
//                 SalesPersonRec.SetRange("Reporting Manager", 'LDH016');
//                 if SalesPersonRec.FindFirst() then begin
//                     if CLE."Document Type" = CLE."Document Type"::Invoice then begin
//                         SalesInvLine.Reset();
//                         SalesInvLine.SetRange("Document No.", CLE."Document No.");
...
//                         if SalesInvLine.FindFirst() then
//                             repeat
//                                 TotalSaleAmtYTDBlank += SalesInvLine."Line Amount";
//                             until SalesInvLine.Next() = 0;
//                     end
//                     else
//                         if CLE."Document Type" = CLE."Document Type"::"Credit Memo" then begin
...
//                             if SaleCrMemoLine.FindFirst() then
//                                 repeat
//                                     TotalSaleAmtYTDBlank += SaleCrMemoLine."Line Amount";
//                                 until SaleCrMemoLine.Next() = 0;
//                         end;
//                 end;
//             UNTIL CLE.NEXT = 0;
...
//         //                     ItemRec.SetFilter("Prod Segment", '<>%1 & <>%2', ItemRec."Prod Segment"::CSG, ItemRec."Prod Segment"::ISG);
...
//         //                     repeat
//         //                         ItemRec.Reset();
//         //                         ItemRec.SetRange("No.", SaleCrMemoLine."No.");
//         //                         ItemRec.SetFilter("Prod Segment", '<>%1 & <>%2', ItemRec."Prod Segment"::CSG, ItemRec."Prod Segment"::ISG);
//         //                         if ItemRec.FindFirst() then
//         //                             TotalSaleAmtYTDBlank += SaleCrMemoLine."Line Amount";
//         //                     until SaleCrMemoLine.Next() = 0;
...
//         ItemLedEntry.Reset();
//         ItemLedEntry.SetRange("Purchase Type", ItemLedEntry."Purchase Type"::"Stock & Sales");
