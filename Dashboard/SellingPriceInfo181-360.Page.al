page 50064 "Selling Price Info 181-360"
{
    ApplicationArea = All;
    Caption = 'Selling Price Information 181-360 Inv Days';
    PageType = List;
    SourceTable = "Item Ledger Entry";
    UsageCategory = Lists;
    SourceTableView = where(Open = const(true), "Inventory Days" = filter(181 .. 360));
    ...
    begin
        ...
        if ItemCatCodeRec.FindFirst() then
            SellingPrice := CostAmount + FinanceCost + (CostAmount * ItemCatRec."Margin 181-360 Days" / 100);
