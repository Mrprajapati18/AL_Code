page 50062 "Selling Price Information >360"
{
    ApplicationArea = All;
    Caption = 'Selling Price Information above 360 Inv Days';
    PageType = List;
    SourceTable = "Item Ledger Entry";
    UsageCategory = Lists;
    SourceTableView = where(Open = const(true), "Inventory Days" = filter(> '360'));
    ...
    begin
        ...
        if ItemCatCodeRec.FindFirst() then
            SellingPrice := CostAmount + FinanceCost + (CostAmount * ItemCatRec."Margin Above 360 Days" / 100);
