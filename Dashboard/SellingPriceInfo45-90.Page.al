page 50061 "Selling Price Info 45-90"
{
    ApplicationArea = All;
    Caption = 'Selling Price Information 45-90 Inv Days';
    PageType = List;
    SourceTable = "Item Ledger Entry";
    UsageCategory = Lists;
    SourceTableView = where(Open = const(true), "Inventory Days" = filter(45 .. 90));
    ...
    begin
        ...
        if ItemCatCodeRec.FindFirst() then
            SellingPrice := CostAmount + FinanceCost + (CostAmount * ItemCatRec."Margin 45-90 Days" / 100);
